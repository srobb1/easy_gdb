...
if (file_exists("/var/www/html/$access_group/${access_group}_data/egdb_conf/easyGDB_conf.php")){
  echo "first";
  include_once "/var/www/html/$access_group/${access_group}_data/egdb_conf/easyGDB_conf.php";
}else{
  echo "second";
  echo " Group: $access_group";
  $header_img = "header_img.png";
  $root_path = "/var/www/html";
  $egdb_files_folder = "Public/Public_data";
  $easy_gdb_path = "$root_path/Public";
...
?>
  ...
  <head>
    ...
    <link rel="stylesheet" href="/Public/css/easy_gdb.css">
    <link rel="stylesheet" href="/Public/css/loading_datatable.css">
